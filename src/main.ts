...
mainRouter.addHandler("assosagre-detail", assosasgreRouter.getHandler("assosagre-detail")!);
mainRouter.addHandler("assosagre-list", assosasgreRouter.getHandler("assosagre-list")!);
